...
const AddTask = () => {
    ...
    return (
        <div className="bg-white p-6 rounded-2xl shadow-md flex flex-col items-center space-y-4 row-start-5 md:row-start-3 md:col-start-1 md:col-span2 lg:row-start-1 lg:col-start-4 lg:col-span-2">
            <Modal
                opened={openModal}
            ...
            <form className="w-full" onSubmit={(e) => handleFormSubmit(e)}>
                ...
                <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">Add Task</button>
            </form>
        </div>
    );
}
